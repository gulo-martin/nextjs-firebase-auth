...
export default function Home() {
  ...
  return (
    <div className=" md:grid grid-cols-1 md:grid-cols-3 w-full flex-col min-h-screen items-center justify-center ">
        ...
        <div className="image h-full w-full col-span-1 contrast-less:  md:col-span-2">
          <Image src={MainImage} alt="welcome image"  className="object-cover h-[20vh] md:h-full w-full" />
        </div>

        <div className="main contain-content relative col-span-1 flex flex-col h-full  text-center w-[100%] mx-auto ">

            <div className="bottom relative h-full w-full flex flex-col  justify-center items-center">
